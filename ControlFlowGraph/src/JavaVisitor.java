...
public interface JavaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code tryBlockStmt}
	 * labeled alternative in {@link JavaParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTryBlockStmt(JavaParser.TryBlockStmtContext ctx);
	/**
	 * Visit a parse tree produced by the {@code tryRescSpecStmt}
	 * labeled alternative in {@link JavaParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTryRescSpecStmt(JavaParser.TryRescSpecStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitContStmt(JavaParser.ContStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitSemiStmt(JavaParser.SemiStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitStmtExprStmt(JavaParser.StmtExprStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIdStmt(JavaParser.IdStmtContext ctx);
	/**
