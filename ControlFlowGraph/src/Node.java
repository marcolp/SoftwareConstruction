public class Node {
    ...
    protected boolean isExitNode; //This is used to determine if this node is where an if/else if/for exits
    ...
    public String toString() {
        return "\n Statement: " + statmt + "  Line Number: " + Integer.toString(lineNumber) + 
            "  Unique ID: " + Integer.toString(uniqueID) + "  Is exit node: "+ isExitNode + "\n\n";
    }
